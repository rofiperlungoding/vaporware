// Central brand/config. Change APP_NAME here to rename the whole product.
...
// Honest disclosure shown to users. The seeded baseline is modeled on real
// painted-door benchmarks (typical click-through 0.5–8%) and the documented
// intention–behavior gap — not pretend live crowd data. Real votes stack on top.
